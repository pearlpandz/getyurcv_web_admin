...
<div class="container">
	<div id="view_profile">
		<ul class="padding-zero col-lg-4 col-md-4 col-sm-4 col-xs-12">
			...
			<li><a id="change_password">Change Password</a></li>
			<li><a id="report_support" class="active">Report and Support</a></li>
		</ul>
		<div class="padding-zero col-lg-8 col-md-8 col-sm-8 col-xs-12">
			...
			<div id="profile_edit2" style="display: none;">
