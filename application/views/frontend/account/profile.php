...
<div id="profile">
	<div class="container">
		<div id="about_user">
			...
			<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 profile_details">
				<div class="row1">
					...
					<a href="<?php echo base_url(); ?>frontend/profile/view_profile_edit">edit profile</a>
					<span id="account_options"><i class="fa fa-sun-o" aria-hidden="true"></i></span>
				</div>
				<div class="row2">
					<a><b><?php echo $posts_count; ?></b> posts</a>
					<a href=""><b><?php echo $followers_count; ?></b> followers</a>
		...
		<div class="profile_options" style="display: none;">
			...
			<ul>
				<li>
					<a href="<?php echo base_url();?>frontend/profile/change_password_view">change password</a>
				</li>
				<li>
					<a href="<?php echo base_url();?>frontend/users/signout">log out</a>
				</li>
				<li>
					<a href="<?php echo base_url();?>frontend/profile/report_support_view">report and support</a>
				</li>
				<li>
